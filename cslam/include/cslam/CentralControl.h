 ...
 public:
  ...
  void UnLockComm() {
    ...
    if (mbCommLock) {
      ...
      cout << "\033[1;31m!!! ERROR !!!\033[0m \"CentralControl\": Attempt to "
              "UnLock Comm -- was not locked"
           << endl;
  ...
  void UnLockPlaceRec() {
    ...
    if (mbPlaceRecLock) {
      ...
      cout << "\033[1;31m!!! ERROR !!!\033[0m \"CentralControl\": Attempt to "
              "UnLock PlaceRec -- was not locked"
           << endl;
      throw estd::infrastructure_ex();
    }
  }
  void UnLockTracking() {
    ...
    if (mbTrackingLock) {
      ...
      cout << "\033[1;31m!!! ERROR !!!\033[0m \"CentralControl\": Attempt to "
              "UnLock Tracking -- was not locked"
           << endl;
      throw estd::infrastructure_ex();
    }
  }
