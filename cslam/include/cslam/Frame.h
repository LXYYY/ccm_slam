...
class Frame : public boost::enable_shared_from_this<Frame> {
 ...
 public:
  ...
  Frame(const cv::Mat& imGray, const double& timeStamp, extractorptr pExtractor,
        vocptr pVoc, cv::Mat& K, cv::Mat& distCoef, size_t ClientId);
 ...
 public:
  ...
  std::vector<cv::KeyPoint> mvKeys, mvKeysRight;  //, mvKeysRight;
